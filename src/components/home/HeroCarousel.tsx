...
const slides: HeroSlide[] = [
  ...
  {
    title: "PMC",
    subtitle: "The Monitors That Master Grammy Winners",
    description: "Apple Music Studios Los Angeles. Abbey Road. When the world's most demanding engineers need absolute truth in sound, they choose PMC. Now available for your private listening sanctuary.",
    logoKey: "PMC",
    link: "/brands/pmc",
    heroImage: pmcHero,
  },
