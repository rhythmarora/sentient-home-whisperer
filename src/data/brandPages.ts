...
export const brandPages: Record<string, BrandPageData> = {
  ...
  "sonos": {
    ...
    keyProducts: [
      { name: "Arc Ultra", category: "Premium Soundbar", description: "Sonos's flagship Atmos soundbar, with Sound Motion™ bass and reference-grade clarity for film, TV and streaming. The anchor of a Sonos home theatre." },
      { name: "Era 300", category: "Spatial Audio Speaker", description: "Purpose-built for Dolby Atmos Music. Six drivers fire in multiple directions to render spatial recordings the way they were mixed." },
      { name: "Era 100", category: "Wireless Speaker", description: "True stereo from a single compact speaker. The everyday Sonos for bedrooms, kitchens and studies." },
      { name: "Sub & Sub Mini", category: "Wireless Subwoofers", description: "Force-cancelling subwoofers that disappear visually and sonically — adding effortless low-end to any Sonos system." },
      { name: "Sonos Amp", category: "Architectural Amplifier", description: "125W per channel of Class-D power for in-ceiling, in-wall and outdoor speakers. The brain of every architectural Sonos zone." },
      { name: "Architectural by Sonance", category: "In-Ceiling / In-Wall / Outdoor", description: "A complete family of plaster-friendly in-ceiling, in-wall and outdoor speakers, Trueplay-tuned via Sonos Amp." },
      { name: "Move 2 & Roam 2", category: "Portable Speakers", description: "Battery-powered Sonos for terraces, gardens, bathrooms and travel — with Wi-Fi and Bluetooth." },
      { name: "Sonos Ace", category: "Headphones", description: "Lossless, spatial-audio headphones with TV Audio Swap — switch the soundbar's output to your headphones with one tap." },
    ],
    timeline: [
