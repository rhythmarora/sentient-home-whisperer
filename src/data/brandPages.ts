...
export const brandPages: Record<string, BrandPageData> = {
  ...
  "pmc": {
    ...
    keyProducts: [
      { name: "Fenestria", category: "Flagship Series", description: "PMC's statement loudspeaker. A 6-driver, 3-way transmission line design that delivers concert-scale dynamics in a stunningly elegant cabinet. The pinnacle of residential audio." },
      { name: "Prophecy", category: "Floor-Standing Series", description: "PMC's most accessible entry into true ATL transmission line performance. A two-way floor-stander engineered for natural, expressive sound in real-world rooms." },
      { name: "Active twenty5i", category: "Active Floor-Standing Series", description: "The legendary twenty5i range, reborn as a fully active system with onboard PMC-engineered amplification and DSP — pure plug-and-play high-end performance." },
      { name: "Prodigy", category: "Compact ATL Series", description: "PMC's compact ATL range — Prodigy1 standmount and Prodigy5 floor-stander. Wide dispersion and effortless bass in footprints suited to modern living spaces." },
      { name: "fact", category: "Signature Series", description: "File Accuracy Confirmation Test. Slim, beautifully crafted floor-standers that bridge the gap between studio monitor precision and residential elegance." },
      ...
      { name: "SE Series — Passive", category: "Reference Passive Series", description: "PMC's reference-grade passive monitors — IB2 SE, MB2 SE, BB5 SE — used in the world's most demanding mastering rooms. Statement-level performance for the home." },
      { name: "SE Series — Active", category: "Reference Active Series", description: "The SE range with integrated active amplification and crossover — the ultimate expression of PMC engineering for cost-no-object listening rooms and private cinemas." },
  ...
  "avantgarde-acoustics": {
    slug: "avantgarde-acoustics",
    name: "Avantgarde Acoustics",
    tagline: "Spherical horns. Pure emotion. Made in Germany.",
    heroSubtitle: "For over three decades, Avantgarde Acoustic has built the world's most recognisable horn loudspeakers — hand-made in Lautertal, Germany. Qubix brings them to Bangalore, on live demo in our Experience Center.",
    partnerBadge: "On Demo — Qubix Experience Center, Bangalore",
    logoKey: "Avantgarde Acoustics",
    founded: "1991",
    headquarters: "Lautertal, Hesse, Germany",
    founders: "Holger Fromme & Matthias Ruff",
    website: "https://www.avantgarde-acoustic.de",
    about: [
      "Avantgarde Acoustic builds loudspeakers around a single, uncompromising idea: the spherical horn. Where conventional speakers force a small driver to move a large volume of air, a horn couples the driver to the room with extraordinary efficiency — producing sound of startling immediacy, dynamics and ease at a fraction of the amplifier power.",
      "Every horn is formed, finished and assembled by hand in Lautertal, Germany. The result is a loudspeaker that is as much a sculpture as an instrument — available in a spectrum of custom colours and finishes, and built to be lived with for decades.",
      "What sets Avantgarde apart from vintage horn designs is engineering rigour. Their spherical wave horns are mathematically derived to avoid the honk and colouration of classic horns, and their active XD subwoofer platform applies DSP, room correction and integrated amplification to the bottom two octaves — giving you horn speed at the top with total bass control below.",
      "Listening to an Avantgarde system is unlike anything else in high-end audio. Voices appear in the room with unnerving presence, transients arrive with no compression, and even at whisper-level volume the music stays complete.",
    ],
    qubixRelationship: "Avantgarde Acoustics is on live demo at the Qubix Experience Center in Bangalore. We design, install and calibrate complete Avantgarde systems — matching horn model to room size, choosing the right XD subwoofer configuration, and integrating them into architecture, dedicated listening rooms and reference cinemas.",
    technologies: [
      { name: "Spherical Wave Horns", description: "Mathematically derived horn geometry that expands as a true spherical wavefront — delivering the dynamics and efficiency of a horn without the colouration and 'honk' of classic designs." },
      { name: "Extreme Efficiency", description: "Sensitivities of 104-107 dB mean a single watt fills a room. Amplifiers loaf, distortion collapses, and micro-detail survives all the way down to low listening levels." },
      { name: "XD Active Bass", description: "Avantgarde's active subwoofer platform pairs integrated amplification with DSP room correction, giving precise control over level, phase, slope and EQ — so the bass keeps pace with the horns." },
      { name: "iTRON Current Drive", description: "A current-driven amplification topology developed by Avantgarde that removes the voice-coil's electrical distortion from the equation, unlocking a further leap in transparency and dynamics." },
      { name: "Hand-Made in Germany", description: "Horns, cabinets and crossovers are produced in-house in Lautertal, in bespoke colours and finishes — every pair effectively made to order." },
    ],
    keyProducts: [
      { name: "Trio G3", category: "Flagship Horn System", description: "The statement Avantgarde system — a three-way, fully horn-loaded loudspeaker partnered with Basshorn arrays. The most complete expression of spherical horn engineering." },
      { name: "Duo GT", category: "Reference Horn Series", description: "The Grand Tourer of the range: two spherical horns above an XD active bass module, in a slim, sculptural cabinet built for reference listening rooms." },
      { name: "Duo SD", category: "Horn Series", description: "The classic Duo silhouette with XD active bass — vast dynamics and holographic imaging in a footprint that works in real living spaces." },
      { name: "Uno SD", category: "Compact Horn Series", description: "The most accessible full horn system Avantgarde builds. Mid-range horn plus active XD bass, engineered for medium-sized rooms." },
      { name: "Mezzo", category: "Horn Series", description: "A refined mid-size horn system that balances scale, resolution and room-friendliness — ideal for the modern luxury apartment or villa listening room." },
      { name: "Opus 1", category: "Modern Horn Design", description: "Avantgarde's contemporary reinterpretation of the horn — an architectural, design-forward loudspeaker that hides serious engineering behind sculptural form." },
      { name: "Zero / iTRON", category: "Active Integrated", description: "A fully active, DSP-controlled horn system with onboard iTRON current-drive amplification. Plug in a source and you have a complete high-end system." },
      { name: "Subwoofers", category: "Active Bass", description: "SUB225, SUB231 and Twin subwoofer systems with integrated amplification and room correction — designed to extend any Avantgarde system or a dedicated cinema." },
      { name: "Colibri", category: "Horn Loudspeaker", description: "A compact, jewel-like horn loudspeaker that brings the Avantgarde signature into smaller and more design-sensitive rooms." },
    ],
    timeline: [
      { year: "1991", title: "Founded in Lautertal", description: "Holger Fromme and Matthias Ruff set out to solve the horn's classic flaws with modern spherical wave geometry." },
      { year: "1993", title: "The First Trio", description: "Avantgarde's first fully horn-loaded three-way system establishes the brand's visual and sonic signature." },
      { year: "1998", title: "Duo Arrives", description: "The Duo brings horn-loaded performance into a form and price accessible to serious private listening rooms worldwide." },
      { year: "2015", title: "XD Active Bass Platform", description: "DSP-controlled active bass modules give owners precise room integration for the first time." },
      { year: "2019", title: "iTRON Current Drive", description: "Avantgarde introduces current-drive amplification, a fundamental rethink of how a driver should be powered." },
      { year: "2023", title: "G3 Generation", description: "Trio G3 and Duo GT launch, refining horn geometry, cabinet construction and bass integration across the range." },
    ],
    sources: [
      { label: "Avantgarde Acoustic Official Website", url: "https://www.avantgarde-acoustic.de" },
      { label: "Avantgarde Acoustic — Products", url: "https://www.avantgarde-acoustic.de/en/products/" },
    ],
    instagramUrl: "https://www.instagram.com/avantgardeacoustic/",
    seo: {
      title: "Avantgarde Acoustics Bangalore | Horn Speakers on Demo — Qubix",
      description: "Hear Avantgarde Acoustic spherical horn loudspeakers in Bangalore at the Qubix Experience Center. Trio G3, Duo GT, Duo SD, Uno SD, Mezzo and Opus 1 — hand-made in Germany.",
      h1: "Avantgarde Acoustics — Horn Loudspeakers on Demo in Bangalore",
    },
    contactFormFields: [
      { label: "Name", name: "name", type: "text", placeholder: "Your name", required: true },
      { label: "Email", name: "email", type: "email", placeholder: "your@email.com", required: true },
      { label: "Phone / WhatsApp", name: "phone", type: "tel", placeholder: "+91", required: true },
      { label: "What interests you most?", name: "interest", type: "select", options: [
        "Avantgarde Trio G3 Flagship System",
        "Duo GT / Duo SD Reference System",
        "Uno SD / Mezzo for a Living Room",
        "Opus 1 / Colibri Design-Led Systems",
        "Hear Avantgarde on Demo in Bangalore",
        "Other / General Enquiry",
      ], required: true },
      { label: "Property Type", name: "propertyType", type: "select", options: [
        "Apartment / Penthouse", "Villa / Bungalow / Independent Home", "Farmhouse / Weekend Home", "Commercial / Hospitality"
      ] },
      { label: "Tell us about your space and vision", name: "message", type: "textarea", placeholder: "Describe your room, your current system, and what you'd like to achieve." },
    ],
  },
  "crestron-home": {
    slug: "crestron-home",
  ...
  "sonos": {
    slug: "sonos",
    name: "Sonos",
    tagline: "The home of wireless multi-room sound.",
    heroSubtitle: "Sonos invented multi-room wireless audio. Qubix is a Sonos Platinum Install Partner — designing, installing and tuning Sonos systems across luxury residences in Bangalore, from a single Era to a fully architectural whole-home build.",
    partnerBadge: "Sonos Platinum Install Partner",
    logoKey: "Sonos",
    founded: "2002",
    headquarters: "Santa Barbara, California, USA",
    founders: "John MacFarlane, Tom Cullen, Craig Shelburne & Trung Mai",
    website: "https://www.sonos.com",
    about: [
      "Sonos is a leading audio technology company that revolutionised how people listen and connect to sound. Founded in 2002 by four music-loving engineers in Santa Barbara, California, Sonos set out with a simple goal — make it easy to play any song in any room.",
      "Since inventing wireless multi-room audio, Sonos has continued innovating across wireless speakers, home theatre systems, headphones, architectural components, and whole-home audio solutions — defining categories and pushing the boundaries of what's possible at home.",
      "With a portfolio of 4,000+ patents, breakthroughs like Trueplay room tuning, Sub's force-cancelling architecture, the Arc soundbar with Dolby Atmos, and the spatial-audio Era 300, Sonos has shaped the way modern homes listen — beautifully software-driven, effortlessly multi-room.",
      "The Sonos Soundboard — Oscar and GRAMMY-winning producers, mixers and engineers led by Sound Experience Leader Giles Martin — fine-tunes every product so listeners hear (and feel) music exactly the way creators intended.",
    ],
    qubixRelationship: "Qubix is a Sonos Platinum Install Partner — the highest tier of Sonos's installer programme. We design, install, tune and support Sonos systems across some of Bangalore's most ambitious residences: in-ceiling Sonos Architectural by Sonance, Arc Ultra cinemas, Era 300 spatial audio rooms, outdoor zones, and whole-home control integrated with Crestron, Lutron and KNX.",
    technologies: [
      { name: "Trueplay™ Tuning", description: "Sonos's room-correction technology measures the acoustics of a space using an iPhone or the speaker's own microphones, then fine-tunes EQ to that specific room — essential for in-ceiling and architectural installs." },
      { name: "Sonos S2 Platform & App", description: "One app, every room, every service. The Sonos S2 software stack delivers reliable multi-room sync, Hi-Res audio support, integrated streaming services, and effortless control across the whole home." },
      { name: "Force-Cancelling Acoustics", description: "Originally pioneered in Sub, force-cancelling driver geometry virtually eliminates cabinet vibration and distortion — now used across Arc Ultra, Era 300 and the Sub family." },
      { name: "Spatial Audio (Era 300 & Arc)", description: "Purpose-built drivers fire sound up, out and to the sides to render Dolby Atmos Music and Atmos cinema content with true height and width — without bouncing everything off the ceiling." },
      { name: "Sonos Voice & Multi-Assistant", description: "Sonos One was the first smart speaker to support multiple voice assistants. Sonos Voice Control adds private, on-device control with no cloud-side compromises." },
      { name: "Sonos Architectural by Sonance", description: "In-ceiling, in-wall and outdoor speakers co-engineered with Sonance, with auto-detect setup and Trueplay tuning when paired with Sonos Amp — the cleanest way to take Sonos invisible." },
    ],
    keyProducts: [
      { name: "Arc Series", category: "Premium Soundbars", description: "Sonos's flagship Atmos soundbar family — Arc and Arc Ultra — anchoring reference-grade home cinema with Sound Motion™ bass and cinematic clarity." },
      { name: "Era Series", category: "Wireless Speakers", description: "Era 100 for true stereo in a compact form, and Era 300 purpose-built for Dolby Atmos Music — six drivers firing in multiple directions for genuine spatial sound." },
      { name: "Sub", category: "Wireless Subwoofers", description: "Sub, Sub Mini and Sub 4 — force-cancelling subwoofers that disappear visually and sonically while adding effortless low-end to any Sonos system." },
      { name: "Sonos Amp", category: "Architectural Amplifier", description: "125W per channel of Class-D power for in-ceiling, in-wall and outdoor speakers — the brain of every architectural Sonos zone, with HDMI ARC for TV." },
      { name: "Sonos Amp Multi", category: "Multi-Zone Amplifier", description: "Multi-zone Sonos amplification for whole-home installs — driving multiple architectural zones from a single rack location." },
      { name: "Sonos Port", category: "Streaming Pre-Amp", description: "Adds Sonos streaming and multi-room control to an existing amplifier or hi-fi system — line-in and line-out for seamless integration with legacy audio." },
      { name: "Sonance by Sonos", category: "Architectural Speakers", description: "In-ceiling, in-wall and outdoor speakers co-engineered with Sonance — auto-detect setup and Trueplay tuning via Sonos Amp. The cleanest way to take Sonos invisible." },
    ],
    timeline: [
      { year: "2002", title: "Founded in Santa Barbara", description: "Four music-loving engineers set out to make it easy to play any song in any room." },
      { year: "2004", title: "Wireless Multi-Room Sync", description: "Sonos patents a solution for syncing wireless audio across multiple devices — the foundation of the category." },
      { year: "2009", title: "All-In-One Speakers & Stereo Pair", description: "Wireless home audio becomes mainstream; matching speakers can be bonded into a true stereo pair." },
      { year: "2012", title: "Sub Debuts", description: "Force-cancelling acoustic architecture virtually eliminates cabinet distortion." },
      { year: "2013", title: "Playbar & Home Theatre", description: "Sonos brings its multi-room sound to TV, film and games, and adds full surround configurations." },
      { year: "2015", title: "Trueplay Tuning", description: "Sonos makes it easy to fine-tune speakers for the specific acoustics of any room." },
      { year: "2017", title: "Sonos One", description: "The first smart speaker to support multiple voice assistants." },
      { year: "2019", title: "Sonos Architectural by Sonance", description: "Auto-detect setup and Trueplay tuning unlocked for in-ceiling and in-wall speakers via Sonos Amp." },
      { year: "2020", title: "Arc & Dolby Atmos", description: "Arc soundbar brings Dolby Atmos to the Sonos home theatre experience." },
      { year: "2023", title: "Era 300 & Spatial Audio", description: "Breakthrough acoustic design unlocks new listening experiences for spatial audio formats." },
      { year: "2024", title: "Sonos Ace Headphones", description: "Personal surround sound with TV Audio Swap from the Sonos soundbar." },
    ],
    sources: [
      { label: "Sonos — Our Company", url: "https://www.sonos.com/en-in/our-company" },
      { label: "Sonos Architectural by Sonance", url: "https://www.sonos.com/en-in/shop/architectural" },
    ],
    instagramUrl: "https://www.instagram.com/sonos/",
    elfsightAppId: "da17e972-bdba-425f-93f8-77ea2d1ae5e2",
    seo: {
      title: "Sonos in Bangalore | Platinum Install Partner — Qubix",
      description: "Qubix is a Sonos Platinum Install Partner in Bangalore. Whole-home Sonos systems, Arc Ultra cinemas, Era 300 spatial audio, in-ceiling Architectural by Sonance — designed, installed and tuned by Qubix.",
      h1: "Sonos in Bangalore — Platinum Install Partner",
    },
    contactFormFields: [
      { label: "Name", name: "name", type: "text", placeholder: "Your name", required: true },
      { label: "Email", name: "email", type: "email", placeholder: "your@email.com", required: true },
      { label: "Phone / WhatsApp", name: "phone", type: "tel", placeholder: "+91", required: true },
      { label: "What interests you most?", name: "interest", type: "select", options: [
        "Whole-Home Sonos System",
        "Sonos Home Theatre (Arc Ultra)",
        "Era 300 Spatial Audio Room",
        "Sonos Architectural by Sonance (in-ceiling)",
        "Outdoor Sonos",
        "Other / General Enquiry",
      ], required: true },
      { label: "Property Type", name: "propertyType", type: "select", options: [
...
// Lightweight pages for brands we've used in past projects. These get a real
// page at /brands/[slug] but use a shared narrative structure rather than
// custom-written long-form content.
const ecosystemStubs: Array<{
  ...
  { slug: "mcintosh", name: "McIntosh", logoKey: "McIntosh", category: "High-Fidelity & Listening",
    ...
    about: "McIntosh has built handcrafted amplifiers in Binghamton, New York for over seventy years. The blue meters are iconic; the sound is unmistakable — warm, powerful, endlessly musical.",
    website: "https://www.mcintoshlabs.com", headquarters: "Binghamton, New York, USA", founded: "1949",
    whyWeUseIt: "When a client wants amplification that's as much an heirloom as it is an instrument, McIntosh is the answer." },
  { slug: "devialet", name: "Devialet", logoKey: "Devialet", category: "High-Fidelity & Listening",
    tagline: "French engineering. Implosive sound.",
    about: "Devialet's patented ADH technology fuses analogue warmth with digital precision in a single chassis. Phantom speakers deliver impossible bass from impossibly small enclosures.",
    website: "https://www.devialet.com", headquarters: "Paris, France", founded: "2007",
    whyWeUseIt: "Specified when a room demands hi-fi performance with sculptural, near-invisible hardware." },
  { slug: "rotel", name: "Rotel", logoKey: "Rotel", category: "High-Fidelity & Listening",
    tagline: "Musical transparency, the Rotel way.",
    about: "Family-owned since 1961, Rotel has quietly built a reputation for amplification that punches far above its price — favoured by reviewers and engineers worldwide.",
    website: "https://www.rotel.com", headquarters: "Tokyo, Japan", founded: "1961",
    whyWeUseIt: "A go-to for honest, musical amplification in mid-tier and reference systems alike." },
  { slug: "sonance", name: "Sonance", logoKey: "Sonance", category: "Architectural & Distributed Audio",
    tagline: "The architectural speaker, invented here.",
    about: "Sonance invented the in-wall speaker in 1983. Today their Invisible Series disappears entirely behind plaster, while Visual Performance models set the bar for in-ceiling fidelity.",
    website: "https://www.sonance.com", headquarters: "San Clemente, California, USA", founded: "1983",
    whyWeUseIt: "Our default for whole-home audio where the architecture must remain uncompromised." },
  { slug: "amina", name: "Amina", logoKey: "Amina", category: "Architectural & Distributed Audio",
    tagline: "Speakers that vanish into the wall.",
    about: "Amina pioneered plaster-over invisible speakers in the UK over 25 years ago. The driver becomes part of the wall itself — sound emerges from the surface with no visible grille.",
    website: "https://www.aminasound.com", headquarters: "Huntingdon, UK", founded: "1999",
    whyWeUseIt: "When the brief is 'I don't want to see speakers anywhere', this is the answer." },
  { slug: "proficient-audio", name: "Proficient Audio", logoKey: "Proficient Audio", category: "Architectural & Distributed Audio",
    tagline: "Distributed audio, done quietly.",
    about: "Part of the Nice group, Proficient Audio builds reliable, design-forward in-wall, in-ceiling and outdoor speakers — the workhorse of large multi-zone installations.",
    website: "https://www.proficientaudio.com", headquarters: "Carlsbad, California, USA",
    whyWeUseIt: "Specified across larger residences where dozens of zones need to perform consistently for years." },
  { slug: "k-array", name: "K-array", logoKey: "K-Array", category: "Immersive & Performance Audio",
    ...
    website: "https://www.k-array.com", headquarters: "Florence, Italy", founded: "1990",
    whyWeUseIt: "When a private nightclub or large social space needs serious output without visual compromise." },
  { slug: "void-acoustics", name: "Void Acoustics", logoKey: "Void Acoustics", category: "Immersive & Performance Audio",
    tagline: "Club-grade systems, sculpted.",
    about: "British-engineered, sculptural loudspeakers found in the world's most respected nightclubs and listening bars — Berghain, Hï Ibiza, Printworks. Performance is matched only by aesthetic.",
    website: "https://voidacoustics.com", headquarters: "Hampshire, UK", founded: "1992",
    whyWeUseIt: "Specified for private party rooms and home nightclubs where the system itself is part of the design." },
  { slug: "csc-audio", name: "CSC Audio", logoKey: "CSC Audio", category: "Immersive & Performance Audio",
    tagline: "Custom installation specialists.",
    about: "Bespoke loudspeaker engineering for installations where off-the-shelf simply won't fit the brief — be it acoustic, dimensional, or aesthetic.",
    website: "https://csc-audio.com", headquarters: "Italy",
    whyWeUseIt: "Reached for when a room needs a speaker built specifically for it." },
  { slug: "byford-audio", name: "Byford Audio", logoKey: "Byford Audio", category: "Immersive & Performance Audio",
    tagline: "Professional monitoring, residential discretion.",
    about: "Studio-grade monitoring expertise applied to high-end domestic listening environments — accuracy first, always.",
    website: "https://byfordaudio.com", headquarters: "UK",
    whyWeUseIt: "Used in mastering-grade listening rooms where neutrality is non-negotiable." },
  { slug: "trinnov", name: "Trinnov Audio", logoKey: "Trinnov", category: "Cinema & Video Processing",
    tagline: "Room correction, perfected.",
    about: "Trinnov's Optimizer is the gold-standard for digital room correction — used in mixing studios, mastering rooms and the world's most ambitious private cinemas.",
    website: "https://www.trinnov.com", headquarters: "Paris, France", founded: "2003",
    whyWeUseIt: "Every reference-grade cinema we build runs Trinnov processing." },
  { slug: "arcam", name: "Arcam", logoKey: "Arcam", category: "Cinema & Video Processing",
    tagline: "British AV processing since 1976.",
    about: "Arcam's AV processors and integrated amplifiers bring British musicality to the home cinema — a rare combination of stereo finesse and surround precision.",
    website: "https://www.arcam.co.uk", headquarters: "Cambridge, UK", founded: "1976",
    whyWeUseIt: "Specified when clients want a single system that handles both reference music and immersive cinema beautifully." },
  { slug: "stormaudio", name: "StormAudio", logoKey: "StormAudio", category: "Cinema & Video Processing",
    tagline: "Immersive audio processors, ground-up.",
    about: "Purpose-built for immersive formats — Dolby Atmos, DTS:X, Auro-3D — with up to 32 channels of native processing. The choice for serious large-scale private cinemas.",
    website: "https://www.stormaudio.com", headquarters: "Nantes, France", founded: "2014",
    whyWeUseIt: "Our default processor for cinemas with 11.4.6 configurations and beyond." },
  { slug: "lumagen", name: "Lumagen", logoKey: "Lumagen", category: "Cinema & Video Processing",
    tagline: "The world's finest video processor.",
    about: "Lumagen Radiance Pro processors handle scaling, HDR tone-mapping and colour calibration with a precision no projector or display can match on its own. The secret behind the world's best cinemas.",
    website: "https://www.lumagen.com", headquarters: "Beaverton, Oregon, USA",
    whyWeUseIt: "Required to extract reference-grade picture from any flagship projector." },
  { slug: "sim2", name: "SIM2", logoKey: "SIM2", category: "Cinema & Video Processing",
    tagline: "Italian projection, hand-built.",
    about: "SIM2 has built premium home-cinema projectors in Pordenone since 1995 — beautifully engineered, gorgeously finished, and capable of cinema-grade light output.",
    website: "https://www.sim2.com", headquarters: "Pordenone, Italy", founded: "1995",
    whyWeUseIt: "Specified when a client wants the projector itself to be a piece of the room's design." },
  { slug: "powersoft", name: "Powersoft", logoKey: "Powersoft", category: "Amplification & Signal",
    tagline: "Class-D amplification at concert scale.",
    about: "Italian-engineered amplification used by the world's largest touring rigs, brought into residential systems where output, efficiency and reliability matter.",
    website: "https://www.powersoft.com", headquarters: "Florence, Italy", founded: "1995",
    whyWeUseIt: "Powering large multi-room and high-output installations where heat and rack space matter." },
  { slug: "blustream", name: "Blustream", logoKey: "Blustream", category: "Amplification & Signal",
    tagline: "AV distribution, simplified.",
    about: "HDMI matrices, multicast over IP, and audio distribution that just works — Blustream is the quiet backbone of countless multi-room AV systems.",
    website: "https://www.blustream.co.uk", headquarters: "United Kingdom",
    whyWeUseIt: "Behind the scenes in nearly every multi-display, multi-source residence we build." },
  { slug: "basalte", name: "Basalte", logoKey: "Basalte", category: "Infrastructure & Control",
    tagline: "Belgian design for the connected home.",
    about: "Basalte's keypads, touch panels and audio docks are jewellery for the wall — handcrafted in aluminium, brass or stone, designed to be noticed.",
    website: "https://www.basalte.be", headquarters: "Ghent, Belgium", founded: "2006",
    whyWeUseIt: "Specified when the user-interface itself must look as considered as the architecture." },
  { slug: "knx", name: "KNX", logoKey: "KNX", category: "Infrastructure & Control",
    tagline: "The open standard for building intelligence.",
    about: "KNX is the worldwide open standard for home and building automation — a vendor-neutral protocol used in serious residential and commercial projects across Europe and Asia.",
    website: "https://www.knx.org", headquarters: "Brussels, Belgium", founded: "1990",
    whyWeUseIt: "Our preferred backbone when a client wants protocol independence and long-term flexibility." },
  { slug: "ajax", name: "Ajax", logoKey: "Ajax", category: "Security & Access",
    tagline: "Wireless security, beautifully made.",
    about: "Ajax has reimagined home security from the ground up — wireless sensors, sleek hubs, and an app that actually feels like 2026. European-engineered, Grade-2 certified.",
    website: "https://ajax.systems", headquarters: "Kyiv, Ukraine", founded: "2011",
    whyWeUseIt: "When a client wants modern, considered security that doesn't visually clutter the home." },
  { slug: "ekey", name: "ekey", logoKey: "ekey", category: "Security & Access",
    tagline: "Biometric access, Austrian-engineered.",
    about: "ekey is Europe's leading fingerprint-access manufacturer. Used at front doors, gates and amenity rooms — keys become a thing of the past.",
    website: "https://www.ekey.net", headquarters: "Linz, Austria", founded: "2002",
    whyWeUseIt: "Specified when a client wants frictionless, keyless entry without compromising on security." },
];

const stubContactFields: BrandPageData["contactFormFields"] = [
  { label: "Name", name: "name", type: "text", placeholder: "Your name", required: true },
  { label: "Email", name: "email", type: "email", placeholder: "your@email.com", required: true },
  { label: "Phone / WhatsApp", name: "phone", type: "tel", placeholder: "+91", required: true },
  { label: "Tell us about your project", name: "message", type: "textarea", placeholder: "What you're planning, the space, the brief." },
];

ecosystemStubs.forEach((s) => {
  brandPages[s.slug] = {
    slug: s.slug,
    name: s.name,
    tagline: s.tagline,
    heroSubtitle: s.about,
    partnerBadge: `${s.category} · From past projects`,
    logoKey: s.logoKey,
    founded: s.founded ?? "—",
    headquarters: s.headquarters,
    founders: "—",
    website: s.website,
    about: [s.about, s.whyWeUseIt],
    qubixRelationship: s.whyWeUseIt,
    technologies: [],
    keyProducts: [],
    timeline: [],
    seo: {
      title: `${s.name} in India | Specified by Qubix`,
      description: `${s.name} — ${s.tagline} Specified, installed and commissioned by Qubix in past residential projects across India.`,
      h1: `${s.name} — ${s.tagline}`,
    },
