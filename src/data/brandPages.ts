...
const ecosystemStubs: Array<{
  ...
  { slug: "wharfedale", name: "Wharfedale", logoKey: "Wharfedale", category: "High-Fidelity & Listening",
    tagline: "British loudspeaker heritage since 1932.",
    about: "One of the oldest names in hi-fi, Wharfedale's modern Linton and Evo lines pair vintage cabinetry with contemporary drivers — a love letter to the British listening tradition.",
    website: "https://www.wharfedale.co.uk", headquarters: "Huntingdon, UK", founded: "1932",
    whyWeUseIt: "Specified when a client wants serious sound in a cabinet that belongs in the room, not on display." },
